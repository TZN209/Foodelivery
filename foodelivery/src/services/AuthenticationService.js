...
const login = async (user) => {
    ...
    try {
        ...
        let loginResponse = await AuthRequest.post(ApiContants.BACKEND_API.LOGIN, requestBody);
...
const checkUserExist = async (type, value) => {
    try {
        ...
        let userCheckResponse = await AuthRequest.get(ApiContants.BACKEND_API.USER_EXIST, {
            params,
        });
